...
- **⚡ BitTorrent v2 (BEP 52) & Hybrid Dual-Swarm Seeding**: Native support for modern BitTorrent v2 SHA-256 Merkle trees and dual-format Hybrid torrents. Seed to both legacy v1 clients and modern v2 clients simultaneously. 1-click in-place **Upgrade to v2 Hybrid** for completed downloads without re-downloading, with split magnet URI options (Full, v1 Legacy, v2 BEP 52).
